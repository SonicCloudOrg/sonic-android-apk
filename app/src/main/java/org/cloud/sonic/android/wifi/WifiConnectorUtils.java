...
import static org.cloud.sonic.android.util.SSIDUtils.convertToQuotedString;
import static org.cloud.sonic.android.util.VersionUtils.isAndroidQOrLater;
import static org.cloud.sonic.android.util.VersionUtils.isJellyBeanOrLater;
import static org.cloud.sonic.android.util.VersionUtils.isLollipopOrLater;
import static org.cloud.sonic.android.util.VersionUtils.isMarshmallowOrLater;
...
public final class WifiConnectorUtils {
        ...
        final ConnectivityManager.NetworkCallback networkCallback = new ConnectivityManager.NetworkCallback() {
            ...
            public void onAvailable(@NonNull Network network) {
                ...
                handler.postDelayed(() -> {
                    ...
                    if (isAlreadyConnected(wifiManager, scanResult.BSSID)) {
                        wifiConnectionCallback.connectSuccessful();
                    } else {
